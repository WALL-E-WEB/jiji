...
![image-20191230221821528](/image/webpack//image-20191230221821528.png)
...
5. 查看打包后的结果，发现other.bundle.js和main.bundle.js都同时打包了jQuery源文件
    ...
    ![main](/image/webpack//main.bundle.js.png)

    ![other](/image/webpack//other.bundle.js.png)
...
3. 查看`dist`目录
    ...
    ![1558771916946](/image/webpack//1558771916946.png)

4. 查看`vendors~main~other.bundle.js`，其实就是把都用到的jQuery打包到了一个单独的js中

    ![1558772012664](/image/webpack//1558772012664.png)
...
![1559811338075](/image/webpack//1559811338075.png)
